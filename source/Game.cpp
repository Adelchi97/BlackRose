...
void Game::loadTextures() {
    ...
    textureHolder.load(Textures::lab, "Media/Tiles/lab.png");
    textureHolder.load(Textures::wood, "Media/Tiles/wood.png");
    textureHolder.load(Textures::metal, "Media/Tiles/metal.png");
}